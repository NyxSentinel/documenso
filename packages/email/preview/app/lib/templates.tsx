...
export const templates: Record<string, TemplateDefinition> = {
  ...
  'document-rejected': {
    ...
    fields: {
      recipientName: recipientNameField,
      documentName: documentNameField,
      documentUrl: { type: 'text', label: 'Document URL', default: 'https://nyxsentinel.com' },
      rejectionReason: {
        type: 'textarea',
  ...
  'team-email-removed': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'Documenso' },
      teamEmail: { type: 'text', label: 'Team email', default: 'team@nyxsentinel.com' },
    },
  },
  ...
  'confirm-email': {
    ...
    fields: {
      confirmationLink: {
        ...
        default: 'https://nyxsentinel.com/confirm',
      },
    },
  },
  'forgot-password': {
    ...
    fields: {
      resetPasswordLink: {
        type: 'text',
        label: 'Reset link',
        default: 'https://nyxsentinel.com/reset',
      },
    },
  },
  'reset-password': {
