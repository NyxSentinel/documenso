 ...
 * `.nyxsentinel-branded` wrapper rendered in `_recipient+/_layout.tsx`.
 *
 ...
 *   }
 *
 * Equivalent to `.nyxsentinel-branded .my-class { color: red; }` after expansion.
 *
...
export const RecipientBranding = ({ branding, cspNonce }: RecipientBrandingProps) => {
  ...
  const css = `.nyxsentinel-branded { ${innerBody} }`;
