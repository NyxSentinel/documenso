                ...
                <Tooltip>
                  ...
                  <TooltipContent className="z-[99999] max-w-xs text-muted-foreground">
                    <Trans>
                      ...
                      <Link
                        to="https://docs.nyxsentinel.com/users/organisations/members"
                        target="_blank"
                        rel="noreferrer"
                        className="text-nyxsentinel-700 hover:text-nyxsentinel-600 hover:underline"
                      >
                        documentation
                      </Link>
                      .
                                  ...
                                  <OrganisationMemberInviteDialog
                                    ...
                                    trigger={
                                      <Button
                                        type="button"
                                        variant="link"
                                        className="h-auto p-0 font-medium text-nyxsentinel-700 text-sm hover:text-nyxsentinel-600"
                                      >
