  ...
  if (isLoading || state === null) {
    return (
      <div className="relative">
        <Loader className="h-8 w-8 animate-spin text-nyxsentinel" />
      </div>
    );
  }
      ...
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              <Trans>Your email has been successfully confirmed! You can now use all features of NyxSentinel.</Trans>
            </p>
      ...
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              <Trans>Your email has already been confirmed. You can now use all features of NyxSentinel.</Trans>
            </p>
