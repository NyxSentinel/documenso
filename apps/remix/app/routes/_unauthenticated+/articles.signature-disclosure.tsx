  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using NyxSentinel to perform your electronic document signing. The purpose of this disclosure
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by NyxSentinel, you affirm that you have read
