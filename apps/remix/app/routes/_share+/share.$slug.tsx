...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'NyxSentinel - Share' },
    { description: 'I just signed a document in style with NyxSentinel!' },
    {
      property: 'og:title',
      content: 'NyxSentinel - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with NyxSentinel!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for NyxSentinel.
  throw redirect('https://nyxsentinel.com');
};
