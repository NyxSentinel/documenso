        ...
        <div className="mt-6 flex flex-col gap-4">
          <div className="rounded-lg border p-4">
            ...
            <p className="mt-1 text-muted-foreground">
              <Trans>Read our documentation to get started with NyxSentinel.</Trans>
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h2 className="flex items-center gap-2 font-bold text-lg">
              <Link2Icon className="h-5 w-5 text-muted-foreground" />
              <Link to="https://nyxsentinel.com" target="_blank" rel="noopener noreferrer" className="hover:underline">
                <Trans>Discord</Trans>
              </Link>
            </h2>
            <p className="mt-1 text-muted-foreground">
